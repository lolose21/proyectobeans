...
<jsp:useBean id="beantablaenfermo"
...
<html>
    <head>
        ...
        <title>Eliminar enfermo</title>
    </head>
    <body>
        <h1>Eliminar Enfermo</h1>
        <form method="post">
            <label>Introducca Inscripcion</label>
            <input type="number" name="cajaeliminar"/>
        ...
        if(dato != null){
            //si es distinto a null transformamos a numero
